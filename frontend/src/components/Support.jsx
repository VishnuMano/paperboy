...
const Support = forwardRef((props, ref) => {
  return (
    <div ref={ref} className='w-full py-[5rem] px-4 bg-white flex flex-col items-center'>
...
We’re asking you to stand with us in this effort 🚀.</p>
      ...
      <div className='flex justify-center'>
        <a href="https://donate.stripe.com/test_28o9BXeg1bipecg288">
          <button className='sm:mx-3 md:mx-5 bg-black w-[200px] rounded-md font-medium mt-10 px-6 py-3 text-[#E8C547]'>Donate Now</button>
        </a>
        <a href="https://github.com/VishnuMano/paperboy">
          <button className='sm:mx-3 md:mx-5 bg-black w-[200px] rounded-md font-medium mt-10 px-6 py-3 text-[#E8C547]'>Source Code</button>
        </a>
      </div>
    </div>
  );
