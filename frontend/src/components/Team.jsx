      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
        <div className='flex flex-col justify-center'>
          ...
          <p className='md:px-5 text-white'>
            ...
            Prior to building Paperboy, Vishnu worked in machine learning research, transportation tech, and venture capital, 
      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          <p className='md:px-5 text-white'>
            ...
            from around the world, having amassed thousands of views on Youtube.
          </p>
